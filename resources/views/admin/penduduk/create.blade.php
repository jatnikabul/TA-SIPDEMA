                ...
                <div class="box box-success">
                    <div class="box-body">
                        <div class="form-group{{ $errors->has('alamat_lengkap') ? ' has-error' : '' }}">
                            ...
                            <textarea class="form-control" id="alamat_lengkap" rows="3" name="alamat_lengkap"
                    ...
                    <div class="form-group{{ $errors->has('keterangan') ? ' has-error' : '' }}">
                        ...
                        <textarea class="form-control" id="keterangan" rows="3" name="keterangan"
                            value="{!! old('keterangan') !!}" placeholder=""></textarea>
                    ...
                    <div class="form-group{{ $errors->has('alamat_email') ? ' has-error' : '' }}">
                        ...
                        <div class="input-group{{ $errors->has('alamat_email') ? ' has-error' : '' }}">
                            ...
                            <input type="email" class="form-control datepicker" id="alamat_email"
                                name="alamat_email" value="{!! old('alamat_email') !!}" placeholder="">
                    ...
                    <div class="form-group{{ $errors->has('nomor_handphone_2') ? ' has-error' : '' }}">
                        ...
                        <div class="input-group{{ $errors->has('nomor_handphone_2') ? ' has-error' : '' }}">
                            <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                            <input type="number" class="form-control datepicker" id="nomor_handphone_2"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" required name="kedudukan_dalam_keluarga">
                                <option value="-">Pilih Kedudukan Dalam Keluarga</option>
                                <option value="kepala keluarga" @if (old('kedudukan_dalam_keluarga')=='Kepala keluarga' ) selected @endif>Kepala
                                    Keluarga</option>
                                <option value="Istri" @if (old('kedudukan_dalam_keluarga')=='Istri' ) selected
                                    @endif>Istri</option>
                                <option value="Anak" @if (old('kedudukan_dalam_keluarga')=='anak' ) selected @endif>
                                    Anak</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" required name="pendidikan_terakhir">
                                ...
                                <option value="SD" @if (old('pendidikan-terakhir')=='SD' ) selected @endif>SD
                                </option>
                                <option value="SMP" @if (old('pendidikan-terakhir')=='SMP' ) selected @endif>SMP
                                </option>
                                <option value="SMA" @if (old('pendidikan-terakhir')=='SMA' ) selected @endif>SMA
                                </option>
                                <option value="SMK" @if (old('pendidikan-terakhir')=='SMK' ) selected @endif>SMK
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group{{ $errors->has('dapat_membaca') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control datepicker" id="dapat_membaca"
                                    name="dapat_membaca" value="{!! old('dapat_membaca') !!}" placeholder="">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" required name="pekerjaan">
                                ...
                                <option value="Belum/Tidak Bekerja" @if (old('pekerjaan')=='Belum/Tidak Bekerja' )
                                    selected @endif>Belum/Tidak Bekerja</option>
                                <option value="Buruh" @if (old('pekerjaan')=='Buruh' ) selected @endif>Buruh
                                </option>
                                <option value="Pelajar/Mahasiswa" @if (old('pekerjaan')=='Pelajar/Mahasiswa' )
                                    selected @endif>Pelajar/Mahasiswa</option>
                                <option value="Pegawai-Negeri-Sipil" @if (old('pekerjaan')=='Pegawai Negeri Sipil' )
                                    selected @endif>Pegawai Negeri Sipil</option>
                                <option value="Pensiunan" @if (old('pekerjaan')=='Pensiunan' ) selected @endif>
                                    Pensiunan</option>
                                <option value="Tentara Nasional Indonesia" @if (old('pekerjaan')=='Tentara Nasional Indonesia' ) selected @endif>Tentara
                                    Nasional Indonesia</option>
                                <option value="Kepolisian RI" @if (old('pekerjaan')=='Kepolisian RI' ) selected
                                    @endif>Kepolisian RI</option>
                                <option value="Karyawan BUMN" @if (old('pekerjaan')=='Karyawan BUMN' ) selected
                                    @endif>Karyawan BUMN</option>
                                <option value="Karyawan Honorer" @if (old('pekerjaan')=='Karyawan Honorer' )
                                    selected @endif>Karyawan Honorer</option>
                                <option value="Karyawan Swasta" @if (old('pekerjaan')=='Karyawan Swasta' ) selected
                                    @endif>Karyawan Swasta</option>
                                <option value="Wirausaha" @if (old('pekerjaan')=='Wirausaha' ) selected @endif>
                                    Wirausaha</option>
                                <option value="dan lain lain" @if (old('pekerjaan')=='dan lain lain' ) selected
